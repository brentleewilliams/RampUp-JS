...
function checkPassword(){
  if (_passwordInput.value == _password) {window.location.assign('http://stream1.gifsoup.com/view4/1181168/leo-strut-o.gif');} 
  else { alert("Wrong!");
        clearPassword();
        };
...
function addNum(e){
  _num = this.innerHTML;
  _passwordInput.value = _passwordInput.value + _num;
...
// _numbers[2].addEventListener('click', _passwordInput.value = 1);
...
// replace functionName with the function you'd like to call on click
